...
- **Diff minimap** — a right-edge ruler with a bar per change, sized to the
  change; click or drag to jump.
...
![mddiff — diff use-case matrix, inline](change-matrix.png)
...
![mddiff — diff use-case matrix, side by side](change-matrix-split.png)
